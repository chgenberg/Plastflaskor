  ...
  return (
    <main className="mx-auto max-w-3xl px-4 pb-20 pt-36">
      ...
      <div className="mt-8 space-y-4 text-[var(--av-text-secondary)]">
        ...
        <h2 className="av-serif pt-6 text-2xl tracking-[-0.01em] text-[#1d1d1f]">
        ...
        <h2 className="av-serif pt-6 text-2xl tracking-[-0.01em] text-[#1d1d1f]">PET-flaskorna och burkarna har pant</h2>
        <p>
        ...
        <h2 className="av-serif pt-6 text-2xl tracking-[-0.01em] text-[#1d1d1f]">Hållbara transporter</h2>
        <p>
