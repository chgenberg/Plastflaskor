...
export default async function HomePage() {
  ...
  return (
    <main className="pb-20 pt-16">
      <Reveal>
        <section className="av-public-band grid items-center gap-12 md:grid-cols-2">
          <div>
          ...
          <div className="av-media aspect-[4/5] md:aspect-[5/6]">
      ...
      <Reveal>
        <section className="av-public-band grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {[
            ...
            <Link key={c.href} href={c.href} className="group av-lift">
              <div className="av-media aspect-[4/5] shadow-[var(--av-shadow-sm)]">
                <Image src={c.src} alt={c.label} fill className="object-cover" sizes="(max-width: 1024px) 50vw, 25vw" />
      ...
      <Reveal>
        <section className="av-public-band">
          <div className="av-media aspect-[16/9] md:aspect-[21/9]">
      ...
      <Reveal>
        <section className="av-public-band">
          <div className="grid items-center gap-10 md:grid-cols-2">
            <div className="av-media mx-auto aspect-[4/5] w-full max-w-[460px]">
      ...
      <Reveal>
        <section className="av-public-band">
          <div className="grid items-center gap-10 md:grid-cols-2">
            ...
            <div className="av-media order-1 mx-auto aspect-[4/5] w-full max-w-[460px] md:order-2">
      ...
      <Reveal>
        <section className="av-public-band">
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
            {featured.map((p) => (
              <Link key={p.id} href={`/produkter/${p.categorySlug}/${p.slug}`} className="group av-lift">
                <div className="av-media aspect-[4/5]">
                  <Image
      ...
      <Reveal>
        <section className="av-public-band">
          <div className="grid gap-4 md:grid-cols-3">
            <Link href="/login" className="av-card av-lift p-6">
            ...
            <Link href="/offert" className="av-card av-lift p-6">
            ...
            <Link href="/inspiration" className="av-card av-lift p-6">
      ...
      <Reveal>
        <section className="av-public-band max-w-3xl">
